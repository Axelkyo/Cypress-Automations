...
// import apply from '../support/pageObjects/onboardingProcess/applyXMCD';
...
// import onboarding from '../support/pageObjects/onboardingProcess/onbXMCD';
...
describe("Onboarding Process Automation", function () {
  ...
  //     // }
    ...
    it.only("Onboarding Forms", function () {
        ...
        // onb.paycard();
        // cy.wait(time);
        // onb.uniform() //uncomment for LIVE
        // cy.wait(time)
        // onb.download() //uncomment for LIVE
        // cy.wait(time)
        onb.consent();
        cy.wait(time);
        onb.agreement();
